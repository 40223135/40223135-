...
class Hello(object):
    ...
    <!-- 啟動 brython() -->
    <body onload="brython()">
        國立虎尾科技大學，機械設計系二年甲班，協同產品設計，第四組35號的個人網頁<br/>
    <a href="legoman">樂高機器人組立</a><br/>
    <a href="index2">協同齒輪</a><br/>
    <a href="geartest">協同第二次上機期末考(個人)</a><br/>
    <a href="geartest2">協同第二次上機期末考(協同)</a><br/>
    ...
    def geartest2(self, m=None, ng1=None, ng2=None, ng3=None, ng4=None, inp2=None):
        outString = ""
        outString +="藍色，35號馮景挺所繪製，齒數1:"+ng1
        outString += "<br />"
        outString +="齒數2:"+ng2
        outString += "<br />"
        outString +="模數:"+m
    ...
    ctx.fillText("組員:35號馮景挺所繪製",x_g1-60, y_g1-10);
...
<canvas id="plotarea" width="800" height="800"></canvas>
    ...
    def mygeartest2(self, m=None, ng1=None, ng2=None, ng3=None, ng4=None, ng5=None, ng6=None, ng7=None, inp2=None):
        ...
        outString +="藍色，35號馮景挺所繪製，齒數1:"+ng1
        outString += "<br />"
        outString +="黑色，35號馮景挺所繪製，齒數2:"+ng2
        outString += "<br />"
        outString +="紅色，35號馮景挺所繪製，齒數3:"+ng3
        outString += "<br />"
        outString +="紫色，35號馮景挺所繪製，齒數4:"+ng4
        outString += "<br />"
        outString +="黃色，35號馮景挺所繪製，齒數5:"+ng5
        outString += "<br />"
        outString +="綠色，35號馮景挺所繪製，齒數6:"+ng6
        outString += "<br />"
        outString +="橘色，35號馮景挺所繪製，齒數7:"+ng7
        outString += "<br />"
        outString +="模數:"+m
        outString += "<br />"
        outString +="壓力角:"+inp2
